...
class GuiHelperTests(unittest.TestCase):
    ...
    def test_verification_status_from_output(self):
        ...
        self.assertEqual(
            verification_status_from_output("Watch rejected PRG file creation: NO_SPACE_FOR_TYPE for 5.15 MB.\n"),
            "PRG too large or no PRG storage available",
        )
        self.assertEqual(
            verification_status_from_output("Watch rejected PRG file creation: NO_SPACE for 5.15 MB.\n"),
            "Not enough watch storage for this PRG",
        )
        self.assertEqual(
